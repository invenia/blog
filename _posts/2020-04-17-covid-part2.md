...
The emissions factor for a fuel type tells us the mass of carbon dioxide emitted per kilowatt-hour (kWh) of energy produced using that fuel.
 Detailed emission factors can be found [here](https://www.gov.uk/government/publications/greenhouse-gas-reporting-conversion-factors-2019) but for our rough estimates we use values of $$ 0.2kg_{CO_2} / kWh $$ and $$ 0.3kg_{CO_2} / kWh $$ for natural gas and brown/hard coal, respectively.
